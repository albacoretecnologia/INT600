...
# -- Toby VCC enable signal
 ...
 echo " "
 echo " "
 echo " Turn TOBY_PWR_ON off and wait for five seconds"
 echo " "
 ...
 echo " "
 echo " "
 echo " Disable TOBY_VCC_EN and wait for two seconds"
 echo " "
 ...
 echo " "
 echo " "
 echo " Enable TOBY_RESET and wait for two seconds"
 echo " "

 echo 1 > /sys/class/gpio/$toby_reset_ioid/value 
 
 echo " "
 echo " Leaving the script with module powered off"
 echo " "
